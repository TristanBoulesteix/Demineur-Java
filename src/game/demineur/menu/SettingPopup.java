...
public class SettingPopup extends JDialog {
	...
	private JComboBox<String> cheveux, profilListBox;
	...
	private void initComponent() {
		...
		profilListBox = new JComboBox<String>();
		profilListBox.setEditable(true);
		profilListBox.setPreferredSize(new Dimension(100, 25));
		...
		profilListBox = new JComboBox<String>();
		profilListBox.addItem("Masculin");
		profilListBox.addItem("Féminin");
		profilListBox.addItem("Indéterminé");
		generalSettingsLabel = new JLabel("");
		othersSettings.add(generalSettingsLabel);
		othersSettings.add(profilListBox);
		...
		okBouton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				info = new SettingPopupInfo((String) profilListBox.getSelectedItem(),
						(String) profilListBox.getSelectedItem(), getAge(), (String) cheveux.getSelectedItem(),
						getTaille());
				setVisible(false);
			}
